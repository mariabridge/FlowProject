			...
			<div>
				...
				<div className="row">
					...
					<div className="col-md-7">
						<div className="row graphContainer" ref="graphContainer" />
				...
				<div className="row save_project">
					<button className="save_project_btn" onClick={this.SaveFlowGraph}><span>Save Project </span> <span className="arrow_icon">→</span></button>
				</div><br/><br/>
			</div>
    	);
	}
	SaveFlowGraph(){
		browserHistory.push('/save-project');
	}
	refreshFlows() {
